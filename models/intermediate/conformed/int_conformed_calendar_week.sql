...
final as (
    ...
    select
        {{ dbt_date.week_start('periods.date_week') }} as week_start_date,
        {{ dbt_date.week_end('periods.date_week') }} as week_end_date,
        {{ dbt_date.week_of_year('periods.date_week') }} as week_of_year,
